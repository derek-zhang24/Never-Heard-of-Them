...
function getSpotifyPlayButtonForPlaylist(title, playlist) {
    ...
    var embed = '<iframe src="https://embed.spotify.com/?uri=spotify:trackset:PREFEREDTITLE:TRACKS" style="width:480px; height:520px;" frameborder="0" allowtransparency="true"></iframe>';
    var tids = [];
